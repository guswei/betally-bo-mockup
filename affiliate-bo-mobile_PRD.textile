...
p. *版本*：v2（2026-06-29）　*類型*：前端 RWD（無後端 schema 變更）　*負責*：PM / RD
p. *變更摘要*：v2 補上報表頁 *Columns Settings* 手機化（顯示/隱藏＋拖曳排序＋Cancel/Reset/Save），新增 FR-9、AC-11/AC-12、ASM-4，並補充凍結首欄「隨排序後第一個顯示欄位變動」規則。
